      ...
      <div className="c-service-sector--grid">
        ...
        <div className="c-service-sector--grid__item" data-aos="fade-right">
          ...
          <Link href='/services/decorative-coatings'>
            <a><div className="c-service-sector--grid__item--image services--decorative-coatings" /></a>
          </Link>
        ...
        <div className="c-service-sector--grid__item" data-aos="fade-left">
          ...
          <Link href='/services/protective-coatings'>
            <a><div className="c-service-sector--grid__item--image services--protective-coatings" /></a>
          </Link>
          <div className="c-service-sector--grid__item--footer">
        ...
        <div className="c-service-sector--grid__item" data-aos="fade-right">
          ...
          <Link href='/services/painting'>
            <a><div className="c-service-sector--grid__item--image services--painting" /></a>
          </Link>
          <div className="c-service-sector--grid__item--footer">
        ...
        <div className="c-service-sector--grid__item" data-aos="fade-left">
          ...
          <Link href='/services/internal-external-paint-spray'>
            <a><div className="c-service-sector--grid__item--image services--internal-external-paint-spray" /></a>
          </Link>
          <div className="c-service-sector--grid__item--footer">
        ...
        <div className="c-service-sector--grid__item" data-aos="fade-right">
          ...
          <Link href='/services/cladding-restoration'>
            <a><div className="c-service-sector--grid__item--image services--cladding-restoration" /></a>
          </Link>
          <div className="c-service-sector--grid__item--footer">
        ...
        <div className="c-service-sector--grid__item" data-aos="fade-left">
          ...
          <Link href='/services/rendering-plastering'>
            <a><div className="c-service-sector--grid__item--image services--rendering-plastering" /></a>
          </Link>
          <div className="c-service-sector--grid__item--footer">
